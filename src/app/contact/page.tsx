                        ...
                        <div className="lg:col-span-5 space-y-16">
                            ...
                            <div className="bg-white border border-primary/5 p-8 dot-grid relative overflow-hidden h-[380px]">
                                <div className="relative z-10 flex flex-col h-full justify-between">
                                    ...
                                    {[
                                        { top: "33%", left: "24%", label: "New York HQ", active: true },
                                        { top: "26%", left: "50%", label: "London HQ", active: true },
                                        { top: "60%", left: "74%", label: "Singapore HQ", active: true },
                                        { top: "25%", left: "55%", label: "Dubai HQ", active: false },
                                    ].map((hub) => (
                                        <div
                                            key={hub.label}
