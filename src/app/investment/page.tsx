...
export default function InvestmentPage() {
    return (
        <SiteLayout>
            ...
            >
                <div className="absolute inset-0 titan-grid opacity-30 pointer-events-none" aria-hidden="true" />
                <div className="max-w-7xl mx-auto px-6 relative">
                    <div className="flex flex-wrap gap-2 mb-12">
                        <Link href="/" className="text-primary/40 text-xs font-bold uppercase tracking-widest hover:text-primary transition-colors">Home</Link>
                        <span className="text-primary/40 text-xs font-bold uppercase tracking-widest">/</span>
                    ...
                    <div className="grid lg:grid-cols-12 gap-12 items-end">
                        ...
                        <div className="lg:col-span-4 pb-4">
                            <p className="text-lg leading-relaxed text-slate-600 max-w-sm">
                                Strategic rigor and financial power for long-term value creation.
                                We deploy capital with institutional precision.
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="grid lg:grid-cols-2 gap-20">
                        ...
                        <div className="flex flex-col gap-6">
                            ...
                            <p className="text-lg leading-relaxed text-slate-600">
                                ...
                                expertise. Our commitment is to the preservation and expansion of
                                capital across generational cycles.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            {/* ═══════════════════════════ SECTOR FOCUS ═══════════════════════════════ */}
            <section className="py-24 border-b border-primary/10 bg-neutral-50" aria-label="Sector Focus Areas">
                <div className="max-w-7xl mx-auto px-6">
